...
const breadcrumbItems: BreadcrumbItem[] = [
    {
        title: 'All Draft Events',
        href: '/manage/events/drafts',
    },
];

const handleDeleteDialogOpen = (event: any) => {
    if (!event) return;
...
const handleDelete = (eventId: number) => {
    ...
    router.delete(`/manage/events/${eventId}`, {
        onSuccess: () => {
...
<template>
    <Head title="Manage Draft Events" />
    ...
    <DashboardLayout :breadcrumbs="breadcrumbItems">
        ...
        <Teleport to="body">
            <CustomDialog
                ...
                :title="'Delete the draft for ' + selectedEvent?.title + '?'"
                description="By deleting the draft for the event, it will be removed from the system permanently."
                @confirm="handleDelete(selectedEvent?.id)"
                :loading="isLoading"
            />
        </Teleport>
    </DashboardLayout>
